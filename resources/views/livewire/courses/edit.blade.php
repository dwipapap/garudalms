        ...
        <form wire:submit="update" class="space-y-4">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button
                    ...
                    wire:loading.attr="disabled"
                    wire:loading.class="opacity-50 cursor-not-allowed"
                    class="bg-red-600 text-white rounded-full px-6 py-2 hover:bg-red-700 font-medium transition-colors disabled:opacity-50"
                >
                    <span wire:loading.remove wire:target="delete">Hapus Course</span>
