...
<body class="bg-gray-50 h-screen">
    <div class="flex h-full w-full">
        ...
        <aside 
            ...
            class="fixed lg:static top-0 left-0 h-full w-64 bg-white border-r border-gray-200 pt-20 lg:pt-0 transition-transform lg:translate-x-0 duration-300 z-30 lg:z-auto overflow-y-auto shrink-0 -translate-x-full"
        >
            <!-- Logo (Desktop) -->
            ...
            <nav class="p-4 space-y-1">
                ...
                @if(auth()->user() && (auth()->user()->hasRole('dosen') || auth()->user()->enrolledCourses()->exists()))
                    <!-- Materials -->
                    <a 
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full">
            <!-- Mobile Header -->
            <div class="lg:hidden bg-white border-b border-gray-200 shrink-0">
